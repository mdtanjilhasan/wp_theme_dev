...
<footer id="footer">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 footer-contact">
                    <h3>Medilab</h3>
                    <p>
                        <?php the_field('footer_address', 33); ?> <br><br>
                        <strong>Phone:</strong> <?php the_field('phone_number', 33); ?><br>
                        <strong>Email:</strong> <?php the_field('email', 33); ?><br>
                    </p>
                </div>
    ...
    <div class="container d-md-flex py-4">
        ...
        <div class="me-md-auto text-center text-md-start">
            <div class="copyright">
                &copy; Copyright <strong><span>Medilab</span></strong>. <?php the_field('copy_right_text', 33); ?>
            </div>
        </div>
...
<script src="<?php echo $basePath . '/public/'; ?>assets/vendor/glightbox/js/glightbox.min.js"></script>
